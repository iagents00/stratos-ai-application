...
const MOCK_LEADS = [
  ...
  { n: "Fam. Rodríguez", phone: "+52 984 123 0001", st: "NEGOCIACION", presupuesto: 4200000, p: "Gobernador 28", campana: "Referido", bio: "Familia inversionista...", asesor: "KEN LUGO RIOS" },
...
async function seed() {
  ...
  // Leads
  // We use the column names we saw in the inspection
