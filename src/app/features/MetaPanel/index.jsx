...
export const DEFAULT_META_PROTOCOL = {
  stages: [
    ...
    { id: 3, name: "Remarketing", color: "#F472B6", sla: "< 48h",
    ...
    { id: 4, name: "Zoom Agendado", color: "#A78BFA", sla: "Confirmado",
    ...
    { id: 5, name: "No Show", color: "#FB7185", sla: "< 2h",
      actions: ["Mensaje empático sin presión — confirmar interés real", "Proponer 2 ventanas alternativas para reagendar", "Llamada de 30s si no responde el chat", "Si en 24h no hay respuesta, mover a Remarketing"] },
    { id: 6, name: "Zoom Concretado", color: "#4ADE80", sla: "< 48h",
      actions: ["Enviar resumen y propuesta formal", "Responder dudas por escrito", "Proponer visita presencial", "Seguimiento en 24h"] },
    { id: 7, name: "Negociación", color: "#FB923C", sla: "< 24h",
      actions: ["Revisar condiciones de pago", "Conectar con notaría aliada", "Validar costos notariales", "Preparar expediente de cierre"] },
    { id: 8, name: "Cierre", color: "#F59E0B", sla: "Inmediato",
