...
import {
  ...
  Mic, FileText, Video, MapPin, TrendingUp, Search, BarChart3, Bell, BellRing, Sparkles, ClipboardList, Zap, Flame, ListChecks, Bot,
  Home, FolderOpen, UserPlus, Users,
} from "lucide-react";
...
const FEATURE_ICONS = { Mic, FileText, Video, MapPin, TrendingUp, Search, BarChart3, Bell, BellRing, ClipboardList, Zap, Flame, ListChecks, Bot, Home, FolderOpen, UserPlus, Users };
              ...
              <div style={{ padding: "18px 0 6px" }}>
                ...
                <div style={{ padding: "0 20px 12px", display: "flex", justifyContent: "space-between", alignItems: "center", borderBottom: `1px solid ${D.line}` }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 9 }}>
                    ...
                    <div>
                      <p style={{ margin: 0, fontSize: 12, color: D.t88, fontWeight: 500, fontFamily: fontDisp, letterSpacing: "-0.01em" }}>{centerLabel}</p>
                      <p style={{ margin: 0, fontSize: 10.5, color: D.t38, fontFamily: font, letterSpacing: "0.02em", marginTop: 1 }}>{msgs.length} actualizaciones del equipo IA</p>
                    </div>
                  </div>
                ...
                <div style={{ padding: "6px 0 10px" }}>
                  {msgs.length === 0 && (
                    <div style={{ padding: "18px 20px", textAlign: "center" }}>
                      ...
                      <p style={{ margin: "4px 0 0", fontSize: 12, color: D.t42, fontFamily: font, lineHeight: 1.5 }}>
                  ...
                  {msgs.map((m, i) => (
                    ...
                    >
                      ...
                      <div style={{ flex: 1, minWidth: 0 }}>
                        ...
                        <p style={{ margin: 0, fontSize: 12, color: D.t42, fontFamily: font, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>{m.text}</p>
                      </div>
                      ...
                      return (
                        ...
                        >
                          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 11 }}>
                            ...
                            <span style={{ fontSize: 9.5, fontWeight: 500, letterSpacing: "0.06em", textTransform: "uppercase", color: isAgent ? D.acc : D.t46, background: isAgent ? "rgba(110,231,194,0.10)" : D.btn, border: `1px solid ${isAgent ? "rgba(110,231,194,0.22)" : D.bd}`, borderRadius: 6, padding: "3px 6px" }}>
                          ...
                          <p style={{ margin: 0, fontSize: 11.5, color: D.t44, fontFamily: font, lineHeight: 1.4, display: "-webkit-box", WebkitLineClamp: 3, WebkitBoxOrient: "vertical", overflow: "hidden" }}>{f.tagline}</p>
                          <div style={{ display: "flex", alignItems: "center", gap: 5, marginTop: 10, paddingTop: 9, borderTop: `1px solid ${D.line}` }}>
                            ...
                            <span style={{ fontSize: 10.5, color: f.color, opacity: 0.9, fontWeight: 400, fontFamily: font }}>{chan}</span>
                          </div>
                        </div>
                      );
                    })}
                  ...
                  {INTEL_FEATURES.map((f) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <p style={{ margin: 0, fontSize: 11, color: D.t44, fontFamily: font, lineHeight: 1.4, display: "-webkit-box", WebkitLineClamp: 2, WebkitBoxOrient: "vertical", overflow: "hidden" }}>{f.tagline}</p>
              ...
              <div style={{ padding: "20px", animation: "fadeSlideDown 0.2s cubic-bezier(0.4,0,0.2,1)" }}>
                <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 16 }}>
                  ...
                  <div style={{ flex: 1 }}>
                    ...
                    <p style={{ margin: 0, fontSize: 11.5, color: D.t40, fontFamily: font, marginTop: 2 }}>Actualización del sistema</p>
                  </div>
                ...
                <div style={{ padding: "18px 20px 22px", animation: "fadeSlideDown 0.2s cubic-bezier(0.4,0,0.2,1)" }}>
                  <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 14 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      ...
                      <p style={{ margin: 0, fontSize: 11, color: isAgent ? D.acc : D.t40, fontFamily: font, marginTop: 2, fontWeight: 400 }}>{isAgent ? "El sistema lo hace solo" : "Lo pides al asistente"}</p>
                    </div>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 9, padding: "10px 13px", borderRadius: 11, background: `${selectedFeature.color}12`, border: `1px solid ${selectedFeature.color}2A`, marginBottom: 18 }}>
                    ...
                    <div>
                      <span style={{ display: "block", fontSize: 10, color: D.t40, fontWeight: 500, fontFamily: fontDisp, letterSpacing: "0.09em", textTransform: "uppercase" }}>Dónde</span>
                      <span style={{ fontSize: 12.5, color: D.t88, fontFamily: fontDisp, fontWeight: 400 }}>{selectedFeature.where}</span>
                    </div>
                  </div>

                  <p style={{ margin: "0 0 9px", fontSize: 10.5, color: D.t42, fontWeight: 500, fontFamily: fontDisp, letterSpacing: "0.08em", textTransform: "uppercase" }}>Cómo se usa</p>
                  <div style={{ display: "flex", flexDirection: "column", gap: 8 }}>
                    {selectedFeature.how.map((step, i) => (
                      <div key={i} style={{ display: "flex", gap: 10, alignItems: "flex-start" }}>
                        <div style={{ width: 18, height: 18, borderRadius: 6, background: `${selectedFeature.color}1A`, border: `1px solid ${selectedFeature.color}30`, color: selectedFeature.color, fontSize: 10.5, fontWeight: 500, fontFamily: fontDisp, display: "flex", alignItems: "center", justifyContent: "center", flexShrink: 0, marginTop: 1 }}>{i + 1}</div>
                        <p style={{ margin: 0, fontSize: 12.5, color: D.t74, fontFamily: font, lineHeight: 1.5 }}>{step}</p>
                      </div>
                    ))}
                  </div>
                </div>
