      ...
      {plusOpen && createPortal(
        <>
          ...
          <div style={{
            ...
            <p style={{ margin:"12px 0 0", textAlign:"center", fontSize:9.5, fontFamily:font, letterSpacing:"0.02em", color: isLight ? "rgba(15,23,42,0.35)" : "rgba(255,255,255,0.28)" }}>Stratos CRM AI · web v241</p>
          </div>
        </>,
        document.body
      )}
