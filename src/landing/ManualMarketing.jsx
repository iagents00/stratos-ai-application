  ...
  },
  {
    ...
    content: [
      ...
      { type: "abilities", items: [
        ...
        { what: "Anotar tu bitácora del día", phrase: "\"hoy edité el video de Casa Lago 3 hrs y grabé en Brasa y Piedra\" — queda registrado tal cual lo dijiste" },
        { what: "Qué reportó el equipo (para el líder)", phrase: "\"¿qué reportó el equipo hoy?\" o \"¿qué reportó Yazz ayer?\"" },
  ...
  },
  {
    ...
    content: [
      ...
      { type: "list", items: [
        ...
        "Si fue de otro día, dilo (\"lo de ayer\") y lo anota en la fecha correcta.",
      ]},
      { type: "p", text: "Después, si tienes la carpeta con lo que hiciste, pásale el enlace y te lo engancha al reporte de ese día: \"esta es la carpeta de hoy: <enlace de Drive>\"." },
      { type: "tip", text: "Se guarda TAL CUAL lo dijiste, con tus horas y tus detalles. No lo resume ni lo acorta: ese detalle es lo que tu líder necesita ver." },
      { type: "warn", text: "No es lo mismo que cerrar una tarea. \"Ya terminé los copys\" cierra esa tarea del tablero; contar tu día completo es la bitácora. Si el Copilot duda, te pregunta cuál de las dos quieres." },
    ],
  },
  {
    id: "lider",
    ...
    summary: "La pestaña Equipo, la bitácora de cada quien y la vista del día de todo el equipo.",
    tags: ["lider", "admin", "equipo", "avance", "vencidas", "bloqueadas", "evidencia", "responsables", "bitacora", "reporte"],
    content: [
      ...
      { type: "list", items: [
        ...
        "Su bitácora: los últimos días que reportó, con el detalle completo y el enlace a su carpeta de evidencia.",
      ]},
      { type: "p", text: "Y si prefieres preguntarlo, el Copilot te lo dice: \"¿qué reportó el equipo hoy?\" o \"¿qué reportó Yazz ayer?\"." },
