 ...
 *
 * Audiencia: la gente del restaurante (cocina, salón, encargado). 0-técnicos:
 * a lo mucho manejan un celular. Español NEUTRO (tú), tono cercano de cocina,
 * cero jerga, tipografía grande. Vive en /manual-brasa (público, sin login)
 * para linkearlo desde Documentos y mandarlo por chat. Familia visual ManualNSG.
 */
...
const APP = "https://app.stratoscapitalgroup.com/brasa-y-piedra";
...
const SECCIONES = [
  ...
  },
  {
    ...
    bloques: [
      { t: "p", v: "Es el chat del restaurante. Escríbele o dictale con el micrófono, con tus palabras — entiende aunque escribas con errores:" },
      { t: "ejemplos", v: [
        ["«ponme una tarea: pedir la proteína al proveedor mañana antes de las 10»", "la crea y te avisa antes"],
        ["«que Carlos consiga la cotización del cocinero nuevo el viernes»", "se la asigna y el sistema la persigue"],
        ["«¿qué tengo hoy?»", "te lista tu día"],
        ["«recuérdame a las 5 sacar el pan del congelador»", "te avisa a la hora exacta"],
        ["«ya quedó lo del proveedor»", "cierra la tarea"],
        ["«¿cuándo se pide la proteína?»", "te responde con lo que sabe del restaurante"],
  ...
  {
    id: "actividades", icono: FolderKanban, titulo: "Actividades — el trabajo del día",
    bloques: [
      { t: "p", v: "Todo lo que hay que hacer, de quién es y para cuándo: pedidos a proveedores, un platillo nuevo, algo para marketing, buscar cocinero o mesero." },
      { t: "tip", v: "Lo más cómodo es no tocar esta pantalla y decírselo al Copilot: «ponme una tarea…» y listo." },
    ],
  },
  {
    ...
    bloques: [
      ...
      { t: "lista", v: [
        ...
        "Documentos: los papeles del restaurante (este manual, contratos, lo que carguen).",
  ...
  },
  {
    ...
    bloques: [
      { t: "p", v: "Lo que entra y lo que sale, anotado el mismo día: la compra al proveedor, la venta del día, cualquier gasto." },
      { t: "lista", v: [
  ...
  },
  {
    ...
    bloques: [
      ...
      { t: "p", v: "Apenas alguien tiene cuenta, el Copilot ya lo reconoce: «que Juan compre el carbón» le llega a Juan." },
    ],
  },
  {
...
export default function ManualBrasa() {
    ...
    <div style={{ minHeight: "100vh", background: P.bg, color: P.txt, fontFamily: font, WebkitFontSmoothing: "antialiased" }}>
      ...
      <header style={{ padding: "56px 20px 30px", textAlign: "center", borderBottom: `1px solid ${P.border}` }}>
        ...
        <p style={{ margin: "10px auto 0", maxWidth: 520, fontSize: 16, lineHeight: 1.6, color: P.txt2 }}>
          Todo lo que hay adentro del espacio de Brasa y Piedra, módulo por módulo, en palabras simples.
        </p>
