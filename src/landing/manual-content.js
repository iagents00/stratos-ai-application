...
export const MANUAL_SECTIONS = [
  ...
  /* ─── INTEGRACIONES ─── */
  {
    ...
    icon: 'Send',
    title: 'Conectar Telegram (opcional, es un plus)',
    summary: 'El Copilot ya hace todo sin Telegram. Conectarlo es opcional: si querés, recibís y registrás también desde tu Telegram personal.',
    tags: ['telegram', 'bot', 'conectar', 'alertas', 'notificaciones', 'opcional'],
    content: [
      { type: 'p', text: 'OJO: conectar Telegram NO es obligatorio. El asistente del CRM (Copilot) hace todo sin Telegram y las notificaciones te llegan al teléfono con la app instalada. Conectar Telegram es un EXTRA para quien además quiera recibir alertas y registrar leads desde su chat de Telegram.' },
      { type: 'steps', items: [
        'En la app, ve a tu Perfil (clic en tu nombre arriba a la derecha).',
        'Busca la sección "Conectar Telegram".',
        'Da clic en "Conectar mi Telegram" (o "Generar código").',
        'Sigue las instrucciones (te dará un código que pegas en el chat con el bot).',
      ]},
      { type: 'tip', text: 'Si lo conectás, recibís los avisos también en tu chat de Telegram — además del Copilot y del teléfono. Si preferís no usarlo, no pasa nada: todo sigue funcionando en el Copilot.' },
    ],
  },
  {
    ...
    summary: 'El asistente inteligente adentro del CRM. Funciona para TODOS con solo tu login — NO hace falta conectar Telegram. Escribile como en un chat y hace todo por vos.',
    tags: ['copilot', 'asistente', 'chat', 'ia', 'bot', 'crm', 'recomendar', 'catalogo', 'drive', 'notificaciones', 'sin telegram'],
    content: [
      { type: 'p', text: 'En el menú del CRM tenés la pestaña "Copilot": el asistente inteligente del sistema. Le escribís (o le mandás un audio) en lenguaje normal y opera tus clientes al instante. IMPORTANTE: funciona con solo tu usuario del CRM — NO necesitás conectar Telegram ni salir del sistema. Todo el equipo puede usarlo desde ya.' },
      { type: 'list', items: [
        'Consultá: "mis clientes", "mi agenda de hoy", "mis KPIs", "el pipeline".',
        'Registrá y actualizá: "crea un cliente Ana 5551234, presupuesto 300 mil", "anota en Felipe que pidió ver más zona norte".',
        'Buscá y trabajá un cliente: "la ficha de Carlos", "pasá a Juan a Zoom Agendado".',
        'Tomá o reasigná un lead: "pasá a Juan y asignámelo a mí", "ponlo en mi cartera".',
        'Catálogo con filtro real: "propiedades en Cancún de menos de 200 mil", "el drive de Tulum" — con su link de Drive.',
        'Recomendaciones: "¿qué le recomiendo al cliente Pepito?" → mira su presupuesto y zona y te propone lo que encaja, con el porqué.',
        'Agendá y recordá: "agenda el Zoom de Carlos el viernes 11am", "recuérdame llamar a Luis en 2 horas".',
        'Si sos admin: "clientes de Gael en segunda etapa", "los últimos 2 leads de Cecilia".',
      ]},
      { type: 'tip', text: 'El asistente ya sabe quién sos por tu login: te muestra TUS clientes desde el primer mensaje. Todo lo que se habla queda en el historial del Copilot (no se borra).' },
      { type: 'tip', text: '📲 ¿Querés que los avisos (Zoom, tareas, recordatorios) te lleguen al teléfono aunque tengas la app cerrada? Instalá Stratos como app en tu celular (ver "Instalar Stratos como app en tu celular") y, cuando el Copilot te muestre el botón "Activar notificaciones", tocalo. Listo: te llegan como un chat.' },
      { type: 'tip', text: 'Telegram es OPCIONAL. Si querés recibir/registrar también desde tu Telegram personal, conectalo desde Perfil (ver "Conectar Telegram"). No es necesario para usar el Copilot.' },
    ],
  },
