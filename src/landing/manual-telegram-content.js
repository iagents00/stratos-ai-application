...
export const MANUAL_SECTIONS_TG = [
  ...
  },
  {
    ...
    summary: 'Decile "recordame…" y a la hora que pediste te escribe. Sirve para cualquier cosa, sea o no de un cliente.',
    tags: ['recordatorio', 'recordame', 'avisame', 'personal', 'alarma', 'acordate', 'recordar'],
    content: [
      { type: 'p', text: 'Además de los avisos automáticos, vos podés pedirle recordatorios cuando quieras. Decile qué y cuándo, y a esa hora te escribe por el chat.' },
      { type: 'ex', items: [
        '"recordame llamar al banco en 2 horas"',
        '"avisame mañana 9am de mandar la propuesta a Carlos"',
        '(audio) "recordame el viernes a las 8 que tengo reunión"',
      ]},
      { type: 'tip', text: 'Entiende fechas en español ("el 3 de agosto", "el viernes 2pm", "en 30 minutos") y respeta tu zona horaria. Es para vos: no aparece en el CRM, es tu recordatorio personal.' },
    ],
  },
  {
    id: 'agendar-visita',
    ...
    summary: 'Programá la visita presencial del cliente. El asistente te recuerda 1 mes, 15 días, 1 semana y 1 día antes.',
    tags: ['visita', 'agendar visita', 'presencial', 'visita agendada', 'recorrido', 'tour'],
    content: [
      { type: 'ex', items: [
        '"agendá la visita de Carlos para el 15 de julio a las 10am"',
  ...
  },
  {
    ...
    tags: ['etapa', 'cambiar etapa', 'pipeline', 'mover', 'seguimiento', 'apartó', 'cierre', 'postventa'],
    content: [
      { type: 'ex', items: [
        '"pasá a Felipe a Seguimiento"',
        '"mové a Sofía a Apartó"',
        '"mové a Beatriz a Cierre, ya firmó"',
      ]},
      { type: 'p', text: 'Reconoce todas las etapas de tu CRM (Contáctame Ya, Segundo Intento, Rotación, Zoom Agendado, Zoom Concretado, Seguimiento, Largo Plazo, Apartó, Visita Agendada, Cierre, Postventa, etc.), no importa si la escribís en minúsculas o sin acentos. Cada movimiento queda en el historial. ¿Te equivocaste? Decile la etapa correcta y lo corrige.' },
    ],
  },
  {
    id: 'buscar-ficha',
    ...
    content: [
      ...
      { type: 'ex', items: [
        ...
        '"la ficha de Carlos"  → sus datos: teléfono, etapa, score, presupuesto.',
        '"¿cuál es el presupuesto de Ana?"  ·  "¿el teléfono de Juan?"',
        '"¿qué sigue con Ana?"  → su próxima acción.',
        '"¿cuándo fue la última acción de Felipe?"',
      ]},
      { type: 'p', text: 'En la ficha vas a ver teléfono, etapa, score, presupuesto y la próxima acción. Desde ahí podés pedir el expediente completo (notas e información) o el historial. Y si el nombre tiene un error de dedo, igual lo encuentra.' },
  ...
  },
  {
    ...
    content: [
      ...
      { type: 'p', text: 'Si sos coordinador o admin, podés pedir los números o la cartera de un asesor en particular:' },
      { type: 'ex', items: [
        '"kpis de Cecilia"        → los números de esa asesora.',
        '"clientes de Gael"       → la cartera de ese asesor.',
        '"el más hot de Cecilia"  → su cliente con más score.',
      ]},
      { type: 'tip', text: 'Un asesor normal solo ve lo suyo; los números o clientes de otro asesor son solo para coordinadores/admins.' },
    ],
  },
  {
  ...
  {
    id: 'documentos-mi-espacio',
    category: 'pedidos',
    icon: 'FileSearch',
    title: 'Pedile un documento de tu espacio (Mi Espacio)',
    summary: 'El asistente te pasa los documentos del equipo (Drive, Notion, Excel, Sheets) que están cargados en "Mi Espacio".',
    tags: ['documentos', 'mi espacio', 'drive', 'notion', 'excel', 'sheets', 'sop', 'archivo', 'links'],
    content: [
      { type: 'p', text: 'Los documentos que el equipo cargó en "Mi Espacio" (en la plataforma: Mi Espacio → Documentos) los podés pedir por chat. Decí "mi espacio" y te muestra la lista, o pedí uno por nombre o por tipo.' },
      { type: 'ex', items: [
        '"mi espacio"  → te lista todos los documentos del equipo.',
        '"mi espacio Tulum Dev"  → te pasa ese documento.',
        '"el excel de mi espacio"  → te pasa el Google Sheets.',
        '"pasame el SOP 3"  → lo busca por nombre.',
      ]},
      { type: 'tip', text: 'Para pedir un documento del equipo, decí "mi espacio" o nombrá el tipo (Notion, Excel, Sheet). "El drive de Tulum Country Club" es del catálogo de propiedades, no de tu espacio — el asistente ya sabe distinguirlos.' },
      { type: 'warn', text: 'Si hay varios parecidos, te pregunta cuál antes de mandarte el equivocado.' },
    ],
  },
  {
    id: 'recomendar-propiedades',
    category: 'pedidos',
    icon: 'Building2',
    title: 'Recomendale propiedades a un cliente',
    summary: 'Decile a qué cliente y te sugiere desarrollos del catálogo según lo que le interesa: su proyecto, su zona y su presupuesto.',
    tags: ['recomendar', 'propiedades', 'cliente', 'presupuesto', 'zona', 'sugerir', 'desarrollos'],
    content: [
      { type: 'p', text: 'El asistente cruza al cliente con el catálogo y te sugiere opciones — priorizando el desarrollo por el que entró y su zona.' },
      { type: 'ex', items: [
        '"¿qué le recomiendo a Juan Carlos?"',
        '"recomendale propiedades a Ana en Playa del Carmen"',
        '"opciones para Sebastián en Cancún"',
      ]},
      { type: 'tip', text: 'Podés fijar la zona ("en Cancún", "en Tulum") y te acota a esa ubicación. El presupuesto del cliente sale como referencia.' },
    ],
  },
  {
    ...
    category: 'pedidos',
    icon: 'MessageCircle',
    title: 'Mensaje para reactivar un cliente dormido',
    summary: 'Te arma un mensaje de WhatsApp listo para reactivar a un cliente que se enfrió, personalizado con la propiedad que le interesa.',
    tags: ['reactivar', 'recuperar', 'dormido', 'abandonado', 'whatsapp', 'mensaje', 'seguimiento'],
    content: [
      { type: 'p', text: '¿Un cliente se enfrió? Pedile el mensaje y te lo arma personalizado (con el proyecto que le interesaba), listo para editar y enviar por WhatsApp.' },
      { type: 'ex', items: [
        '"¿qué le escribo a Juan para reactivarlo?"',
        '"reactivar a Ana"',
        '"mensaje para recuperar a Sebastián"',
      ]},
      { type: 'tip', text: 'El mensaje es un borrador — ajustalo a tu estilo antes de mandarlo. El botón "Abrir WhatsApp" te lleva directo al chat del cliente.' },
      { type: 'p', text: 'El asistente también te avisa solo cuando un cliente lleva días sin movimiento (mirá "Cliente sin movimiento" más abajo).' },
    ],
  },
  {
    id: 'memoria-contexto',
    category: 'pedidos',
    icon: 'Workflow',
    title: 'Hablale seguido: se acuerda del último cliente',
    summary: 'Después de ver un cliente, seguí preguntando "y su teléfono", "su presupuesto" o "su próxima acción" sin repetir el nombre.',
    tags: ['memoria', 'contexto', 'ese cliente', 'su telefono', 'conversacion'],
    content: [
      { type: 'p', text: 'Cuando consultás un cliente, el asistente lo recuerda un rato. Así podés encadenar preguntas naturales:' },
      { type: 'ex', items: [
        '"el más hot de Cecilia"  → te muestra a Dani.',
        '"¿y su teléfono?"  → el de Dani.',
        '"¿su presupuesto?"  → el de Dani.',
        '"¿cuál es su próxima acción?"  → la de Dani.',
      ]},
      { type: 'tip', text: 'Si pasó un rato largo o no sabe de quién hablás, te lo pregunta en vez de adivinar.' },
    ],
  },
  ...
  /* ═══════════ LO QUE HACE SOLO ═══════════ */
  {
    ...
    summary: 'No tenés que estar pidiendo: él te escribe en el momento justo.',
    ...
    content: [
      ...
      { type: 'list', items: [
        ...
        'Recordatorios personales que vos le pediste (ver "Qué le podés pedir").',
      ]},
  ...
  },
  {
    ...
    content: [
      { type: 'p', text: 'Cuando un cliente tiene una Visita Agendada, no tenés que acordarte vos: el asistente te escribe en cada momento clave, con la acción de cada etapa.' },
      { type: 'list', items: [
        '1 mes antes: confirmá la asistencia y ayudá con los vuelos / la logística.',
        '15 días antes: reconfirmá la visita y empezá a preparar la postventa.',
        '1 semana antes: aviso final, dejá todo listo.',
