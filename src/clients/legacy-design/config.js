...
const legacyDesignConfig = {
  ...
  intelFeatures: [
    { id: "tarea-voz", label: "Anotar por voz", icon: "Mic", color: "#6EE7C2", kind: "pedis",
      ...
      how: ['Abre el Copilot y escribe o dicta: "Ponme una tarea: llamar al notario de Casa Ágata mañana a las 10".',
    ...
    { id: "asignar", label: "Repartir el trabajo", icon: "Users", color: "#60A5FA", kind: "pedis",
      ...
      tagline: "Asigna pendientes a la gente del despacho y el sistema los persigue.",
    ...
    { id: "tablero-casas", label: "El tablero de casas", icon: "Search", color: "#34D399", kind: "pedis",
      ...
      how: ["Sustituye el «¿cuándo se entrega Casa Ágata?»: abre el tablero y está.",
