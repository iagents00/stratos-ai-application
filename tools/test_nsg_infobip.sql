...
BEGIN
  ...
  fixture:=jsonb_build_object('results',jsonb_build_array(jsonb_build_object(
    'from','5212025550111','to','5216861936914','integrationType','WHATSAPP',
  ...
  fixture:=jsonb_set(fixture,'{results,0,to}','"526861936914"');
  result:=public.fn_ingest_infobip_nsg(fixture);
  ...
  fixture:=jsonb_set(fixture,'{results,0,to}','"5216861936914"');
  BEGIN
