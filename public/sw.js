...
const CACHE_VERSION = 'stratos-v152'; // v152: Create->hexágono (como el original), Comando->analytics (más sutil), pastilla activa con bordes uniformes (se quita el inset superior que engrosaba el borde de arriba)
